...
#line 38 "..\\FreeRTOS\\Source\\portable\\MemMang\\heap_2.c"
...
#line 45 "..\\FreeRTOS\\Source\\portable\\MemMang\\heap_2.c"
...
#line 46 "..\\FreeRTOS\\Source\\portable\\MemMang\\heap_2.c"
...
static size_t xFreeBytesRemaining = ( ( ( size_t ) ( 8 * 1024 ) ) - 8 );
...
#line 116 "..\\FreeRTOS\\Source\\portable\\MemMang\\heap_2.c"
...
void *pvReturn = 0;
	...
	vTaskSuspendAll();
	{
		...
		if( ( xWantedSize > 0 ) && ( xWantedSize < ( ( ( size_t ) ( 8 * 1024 ) ) - 8 ) ) )
		{
...
#line 205 "..\\FreeRTOS\\Source\\portable\\MemMang\\heap_2.c"
...
uint8_t *pucAlignedHeap;
	...
	xEnd.xBlockSize = ( ( ( size_t ) ( 8 * 1024 ) ) - 8 );
	xEnd.pxNextFreeBlock = 0;

	
 
	pxFirstFreeBlock = ( void * ) pucAlignedHeap;
	pxFirstFreeBlock->xBlockSize = ( ( ( size_t ) ( 8 * 1024 ) ) - 8 );
