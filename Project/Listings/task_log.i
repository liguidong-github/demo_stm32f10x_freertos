...
#line 27 "..\\User\\Task_Log.c"
#line 28 "..\\User\\Task_Log.c"
...
#line 36 "..\\FreeRTOS\\Source\\include\\semphr.h"
...
#line 103 "..\\FreeRTOS\\Source\\include\\semphr.h"
...
#line 33 "..\\User\\Task_Log.c"

 
 
 
 
static QueueHandle_t log_queue_handle = 0;    
static SemaphoreHandle_t log_mutex_handle = 0;
...
int fputc(int ch, FILE *f) {
	...
	int temp_ch = ch;
	xQueueGenericSend( ( log_queue_handle ), ( (void *)&temp_ch ), ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
...
void Log( const char * sFormat, ...)
{
	...
	xQueueSemaphoreTake( ( log_mutex_handle ), ( ( TickType_t ) 0xffffffffUL ) ); 
	
	__va_start(ParamList, sFormat);

	printf(sFormat, &ParamList);
	
	xQueueGenericSend( ( QueueHandle_t ) ( log_mutex_handle ), 0, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ); 
}
...
void TaskLog(void * p_parameters)
{
	...
	log_mutex_handle = xQueueCreateMutex( ( ( uint8_t ) 1U ) ); 

	if( log_mutex_handle == 0 )
	{
		 
		while(1);
	}
	
	log_queue_handle = xQueueGenericCreate( ( 512 ), ( 1 ), ( ( ( uint8_t ) 0U ) ) ); 

	if( log_queue_handle == 0 )
	{
	...
	for( ; ; )
	{
		if( xQueueReceive( log_queue_handle , &( log_char ),( TickType_t ) 0 ) == ( ( ( BaseType_t ) 1 ) ) ) 
		{
			SEGGER_RTT_PutChar(0,(char)log_char);
		}
	}
